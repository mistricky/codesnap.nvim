...
After you run the above commands, CodeSnap will pop up a window to let you select the code you want to highlight, then you can just press the Enter key to confirm the selection, CodeSnap will generate a snapshot with highlight blocks like this:
